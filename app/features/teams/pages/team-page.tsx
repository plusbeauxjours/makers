...
export default function TeamPage() {
    return (
        <div className="space-y-20">
            <Hero title="Join plusbeauxjours's team" />
            <div className="grid grid-cols-6 items-start gap-40">
                <div className="col-span-4 grid grid-cols-4 gap-5">
                    ...
                    <Card className="col-span-2">
                        <CardHeader>
                            <CardTitle className="text-muted-foreground text-sm font-medium">Looking for</CardTitle>
                            <CardContent className="p-0 text-2xl font-bold">
                                <ul className="list-inside list-disc text-lg">
                                    {['React Developer', 'Backend Developer', 'Product Manager', 'UI/UX Designer'].map(
                                        (item) => (
                                            <li key={item}>{item}</li>
                                        )
                                    )}
                    ...
                    <Card className="col-span-2">
                        <CardHeader>
                            ...
                            <CardContent className="p-0 text-xl font-medium">
                                <p>
                                    Doggie Social is a social media platform for dogs. It allows dogs to connect with
