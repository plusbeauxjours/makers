...
import type { Route } from './+types/leaderboard-weekly-page';
        ...
        <div className="space-y-10">
            ...
            <div className="flex items-center justify-center gap-2">
                <Button variant="secondary" asChild>
                    <Link to={`/products/leaderboard/weekly/${previousWeek.year}/${previousWeek.weekNumber}`}>
                        &larr; {previousWeek.toLocaleString(DateTime.DATE_SHORT)}
                    </Link>
                </Button>
                {!isToday ? (
                    <Button variant="secondary" asChild>
                        <Link to={`/products/leaderboard/weekly/${nextWeek.year}/${nextWeek.weekNumber}`}>
