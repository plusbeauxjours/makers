...
import type { Route } from "./+types/leaderboard-monthly-page";
    ...
    <div className="space-y-10">
      ...
      <div className="flex items-center justify-center gap-2">
        <Button variant="secondary" asChild>
          <Link to={`/products/leaderboard/monthly/${previousMonth.year}/${previousMonth.month}`}>
            &larr;{" "}
        ...
        {!isToday ? (
          <Button variant="secondary" asChild>
            <Link to={`/products/leaderboard/monthly/${nextMonth.year}/${nextMonth.month}`}>
