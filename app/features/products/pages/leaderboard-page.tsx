...
export const meta: Route.MetaFunction = () => {
    return [{ title: 'Leaderboards | wemake' }, { name: 'description', content: 'Top products leaderboard' }];
};
    ...
    return (
        <div className="space-y-20">
            ...
            <div className="grid grid-cols-3 gap-4">
                ...
                {loaderData.dailyProducts.map((product: any) => (
                    <ProductCard
            ...
            <div className="grid grid-cols-3 gap-4">
                ...
                {loaderData.weeklyProducts.map((product: any) => (
                    <ProductCard
                        key={product.product_id.toString()}
                        id={product.product_id.toString()}
                        name={product.name}
            ...
            <div className="grid grid-cols-3 gap-4">
                ...
                {loaderData.monthlyProducts.map((product: any) => (
                    <ProductCard
                        key={product.product_id.toString()}
                        id={product.product_id.toString()}
                        name={product.name}
            ...
            <div className="grid grid-cols-3 gap-4">
                ...
                {loaderData.yearlyProducts.map((product: any) => (
                    <ProductCard
                        key={product.product_id.toString()}
                        id={product.product_id.toString()}
                        name={product.name}
